...
namespace ConsoleWarsForum.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        // GET: api/Posts
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Post>>> GetPosts(DateTime? startDateAndTime, DateTime? endDateAndTime, int threadId)
        {
            ...
            if (threadId != 0)
            {
                query = query.Where(post => post.ThreadId == threadId);
            }
